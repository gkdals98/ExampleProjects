...
+ 아니. 이 Go 버튼을 그래서... 맵에서 뭘로 바꿀건데. 그거 안정해지면 암것도 없다. 맵에는 저런 버튼 아무런 소용이 없음. 맵에서 다음 진행할 방 누르고 고 버튼 누르게 하면 해결은 되지. 게임의 스무스한 흐름이 망가질 뿐. 또 클릭하면 선 색 변하고 타일 하이라이트 되는 그런거도 해야됨. 음 일단 다시 생각해보면 뭐 그렇게까지 나쁘진 않은 것 같다. 
...
------
#### Issues
+ Webpack config의 alias 미작동 문제 - 짜증이 나는 것을 넘어 분노에 이르고있다. webpack.base.conf.js에 열심히 설정을 넣어줬지만 전혀, 아무런 영향도 없다. 우선 그냥... ../../../../../ 하자... 참기 힘들어도.
